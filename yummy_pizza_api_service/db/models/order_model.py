...
class Order(BaseModel):
    ...
    """
    contact_type: str = ormar.String(choices=list(OrderType))
    status: str = ormar.String(choices=list(OrderStatus))
    deliver_type: str = ormar.String(choices=list(OrderDeliveryType))
    ...
    items: Optional[List[OrderProduct]] = ormar.ManyToMany(OrderProduct)
    
    transaction: Optional[Transaction] = ormar.ForeignKey(Transaction)
