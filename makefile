...
dev-test:
	docker-compose -f deploy/docker-compose.yml -f deploy/docker-compose.dev.yml --project-directory . run --rm api pytest -vv yummy_pizza_api_service/tests/test_order.py
